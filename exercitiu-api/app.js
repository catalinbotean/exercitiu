...
mongo.MongoClient.connect("mongodb+srv://catalin:botean@cluster0.jcmkf.mongodb.net/exercitiu?retryWrites=true&w=majority", { useUnifiedTopology: true } , (error, client)=>{
    if(error){
